...
def dolzina_zaporedja(n):
    '''izračuna dolžino col. zaporedja'''
    if n == 1: # ustavitveni pogoj
        return 1
    else:
        return 1 + dolzina_zaporedja(naslednji_clen(n))

def dolzina_zaporedja2(n):
    '''izračuna dolžino col. zaporedja'''
    if n == 1: # ustavitveni pogoj
        return 1
    stevilo_clenov = 1 + dolzina_zaporedja(naslednji_clen(n))
    print (stevilo_clenov)
    return stevilo_clenov
# =====================================================================@000948=
# 3. podnaloga
...
def najvecji_clen(n):
    if n == 1:
        return 1 # ustavitveni pogoj
    else:
        trenutni_clen = n 
        return max (trenutni_clen, najvecji_clen(naslednji_clen(n)))
# =====================================================================@000949=
# 4. podnaloga
...
def _validate_current_file():
    ...
    try:
        ...
        token = 'Token 750ce1973a85daf3306aa762b11754520eba549e'
